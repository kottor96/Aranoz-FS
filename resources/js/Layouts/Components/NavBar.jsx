...
export default function NavBar(){
    ...
    return <nav className="relative bg-gray-800/50 after:pointer-events-none after:absolute after:inset-x-0 after:bottom-0 after:h-px after:bg-white/10">
                        ...
                        >
                            ...
                            {auth.user ? (
                                    ...
                                    <>
                                        <Link
                                            href={route('login')}
                                            className="rounded-md px-4 py-2 text-gray-300 ring-1 ring-transparent transition hover:text-black/70 focus:outline-none focus-visible:ring-[#FF2D20] block"
                                        >
                                            Log in
                                        </Link>
                                        <Link
